...
import {
  BodyInfo,
  BodyInfoRecordRequest,
  Weight,
  WeightRecordRequest,
} from "@/types/member/record";
      ...
      <BaseContentWrap>
        ...
        <ContentSection>
          <TitleWrap>
            {todayBodyInfos ? (
              <div className="recent-date">
                최근기록{" "}
                {todayBodyInfos.weights[0]?.recentUploadDate &&
                  format(
                    new Date(todayBodyInfos.weights[0].recentUploadDate),
                    "MM월 dd일",
                  )}
              </div>
            ) : (
          ...
          <WeightBox variant="purple">
            ...
            {showBtn && (
              <WeightSaveBtn $variant="primary" onClick={handleWeightSave}>
                저장
              </WeightSaveBtn>
            )}
          </WeightBox>
          ...
          <TitleWrap>
            ...
            {todayBodyInfos ? (
              <div className="recent-date">
                최근기록{" "}
                {format(
                  new Date(todayBodyInfos.bodyInfo.recentUploadDate),
                  "MM월 dd일",
                )}
              </div>
            ) : (
            ...
            {bodyInfoInput.skeletalMuscle > 0 ? (
              <>
                ...
                >
                  ...
                  <CompositionValueText>
                    {bodyInfoInput.skeletalMuscle} kg
                  </CompositionValueText>
            ...
            {bodyInfoInput.bodyFatPercentage > 0 ? (
              <>
                ...
                >
                  ...
                  <CompositionValueText>
                    {bodyInfoInput.bodyFatPercentage} %
                  </CompositionValueText>
        ...
        <ContentSection>
          <TitleWrap variant="bodyphoto">
            ...
            <div
              className="bodyphoto-history"
              onClick={() => router.push("/member/record/weight/bodyphoto")}
            >
              눈바디 히스토리
            </div>
          </TitleWrap>
